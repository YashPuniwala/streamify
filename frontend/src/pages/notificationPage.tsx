...
export interface AcceptedRequestNotification extends NotificationBase {
...
export type Notification = FriendRequestNotification | AcceptedRequestNotification;

export interface NotificationsResponse {
  incomingReqs: FriendRequestNotification[];
  acceptedReqs: AcceptedRequestNotification[];
}
